...
public class GlobalExceptionHandler {
     ...
     */
    @ExceptionHandler({org.springframework.security.authentication.BadCredentialsException.class, io.jsonwebtoken.JwtException.class})
    ...
    public ResponseEntity<ApiResponse<ErrorDetailsDto>> handleAccessDenied(org.springframework.security.access.AccessDeniedException ex) {
